...
@section('title', 'Nuevo tipo de porterias')
...
<div class="card card-outline card-primary">
	...
	<div class="card-body" style="display: block;">
        <form id="formularioTipoPorteria" method="POST" action="{{ route('tipoporterias.store') }}" >
            @csrf


            @include('tipoporterias.form._tipoporteria')
