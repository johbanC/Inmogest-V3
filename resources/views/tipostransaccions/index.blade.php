        ...
        <table id="example1" head-theme="light" theme="light" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar" data-toggle="modal" data-target="#modalEditar{{ $tipostransaccion->id }}">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        var formulario = document.getElementById("formulariotipostransaccion");
