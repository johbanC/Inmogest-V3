...
@section('title', 'Editar tipo transacciones')
...
<div class="card card-outline card-primary">
	...
	<div class="card-body" style="display: block;">
		<form action="{{ route('tipostransaccions.update', $tipotransaccion) }}" method="POST">
			@csrf
			@method('PUT')
			...
			@include('tipostransaccions.form._tipotransacciones-edit')
